...
const Hero = () => {
  return (
    <section className="relative text-white overflow-hidden">
      ...
      <div className="container mx-auto lg:px-12 px-5 py-24 md:py-32 relative z-10 lg:h-[90vh] flex flex-col justify-center">
            ...
            <div className="bg-white bg-opacity-10 backdrop-filter md:backdrop-blur-lg relative rounded-xl p-8 shadow-2xl">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  ...
                  <span>Next Generation Technology for a Sustainable Future</span>
                </li>
              </ul>
            </div>
          </div>
