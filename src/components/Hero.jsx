...
const Hero = () => {
  return (
    <section className="relative text-white overflow-hidden min-h-[30vh] sm:min-h-[100vh] flex items-start pt-8 sm:pt-0 sm:items-center">
      <div
      ...
      <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-0 sm:py-4 md:py-16 lg:py-24 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-12">
          ...
          >
            <div className="bg-white/10 backdrop-filter backdrop-blur-lg rounded-xl p-4 sm:p-5 md:p-6 shadow-2xl border border-white/10">
