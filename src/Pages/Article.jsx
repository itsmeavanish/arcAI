...
const Article = () => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 bg-gray-700 rounded-lg shadow-lg dark:bg-gray-800 p-5 gap-10 w-4/5 mx-auto'>
                ...
                <div className="sm:p-4 p-2 sm:w-1/2 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-200 dark:text-gray-400">
                            ...
                            delectus dignissimos explicabo quod pariatur at consequatur sint esse
                            aut Facere. <br /> Numquam architecto delectus dignissimos
                        </p>
                    </div>
                    <div className="mt-4">
